...
internal interface BehandlingOperasjoner<EB: EksisterendeBehandling> {
    ...
    fun mapTilNyBehandling(behovssekvensId: BehovssekvensId, grunnlag: Json, personInfo: Map<Identitetsnummer, BehandlingPersonInfo>, behandlingStatus: BehandlingStatus) : Pair<NyBehandling, List<Part>>
}